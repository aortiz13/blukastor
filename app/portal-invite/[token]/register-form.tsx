...
import { Loader2, UserPlus, Mail, Lock, Eye, EyeOff, CheckCircle2, ArrowRight } from 'lucide-react'
...
export default function InviteRegisterForm({ token, companyName, role, inviteEmail }: InviteRegisterFormProps) {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!res.ok) {
                if (data.existing) {
                    setError('Este correo ya está registrado. Usa "Iniciar Sesión" con tu contraseña.')
                } else {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
            <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-xl space-y-6">
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase"><span className="bg-white px-3 text-gray-400 font-bold">¿Ya tienes cuenta?</span></div>
                </div>
                ...
                <button
                    ...
                    className="w-full bg-gray-100 text-gray-700 py-3 rounded-xl font-bold hover:bg-gray-200 transition disabled:opacity-50 text-sm"
                >
